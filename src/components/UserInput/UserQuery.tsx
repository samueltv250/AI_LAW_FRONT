...
export default function UserQuery() {
  ...
  return (
    <form
      className="input shadow-md dark:bg-[#303334] bg-white  dark:border-white border-gray-700 border-2 flex items-center   rounded-md"
    ...
    >
      <div className="w-11/12 p-2">
        <textarea
          ...
          placeholder="Haz una pregunta sobre leyes, politicas, o noticias de panama..."
